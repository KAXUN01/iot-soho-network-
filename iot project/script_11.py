# Create example IoT device simulation for testing
device_simulator = '''#!/usr/bin/env python3
"""
...
with open(f"{project_name}/scripts/device_simulator.py", "w") as f:
    f.write(device_simulator)

print("Created IoT device simulator: scripts/device_simulator.py")